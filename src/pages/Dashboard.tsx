  ...
  const calculateStats = () => {
    ...
    boards.forEach(board => {
      board.tasks.forEach(task => {
        ...
        if (task.columnId === 'todo' || task.columnId === 'todo') {
          tasksByStatus.todo++;
        } else if (task.columnId === 'in-progress' || task.columnId === 'in-progress') {
          tasksByStatus.inProgress++;
        } else if (task.columnId === 'done' || task.columnId === 'done') {
          tasksByStatus.done++;
          completedTasks++;
        }
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-2xl font-bold">{stats.tasksByStatus.todo}</span>
                      <span className="text-sm text-gray-500">tarefas</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-2xl font-bold">{stats.tasksByStatus.inProgress}</span>
                      <span className="text-sm text-gray-500">tarefas</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-2xl font-bold">{stats.tasksByStatus.done}</span>
                      <span className="text-sm text-gray-500">tarefas</span>
                    </div>
                  </div>
                </div>
